...
public class FavoritesContentProvider extends ContentProvider {
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] projection, @Nullable String selection,
        ...
        switch (match) {
            ...
            case FAVORITES_WITH_ID:
                ...
                String mSelection = FavoritesContract.FavoritesEntry._ID + "=?";
    ...
    public int update(@NonNull Uri uri, @Nullable ContentValues values, @Nullable String selection, @Nullable String[] selectionArgs) {
        ...
        switch (match) {
            case FAVORITES:
                updatedCount = db.update(FavoritesContract.FavoritesEntry.TABLE_NAME,
                        values,
                        selection,
                        selectionArgs);
                break;
    ...
    public int delete(@NonNull Uri uri, @Nullable String selection, @Nullable String[] selectionArgs) {
        ...
        switch (match) {
            case FAVORITES:
                deletedCount = db.delete(FavoritesContract.FavoritesEntry.TABLE_NAME,
                        selection,
                        selectionArgs);
                break;
            case FAVORITES_WITH_ID:
            ...
            case FAVORITES:
                ...
                try {
                    for (ContentValues value : values) {
                        long id = db.insert(FavoritesContract.FavoritesEntry.TABLE_NAME, null, value);
                        if (id != -1) {
                            rowsInserted++;
                        }
                    }
